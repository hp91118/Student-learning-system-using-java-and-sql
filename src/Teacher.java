...
public class Teacher extends JFrame implements ActionListener,WindowStateListener{
    ...
    public Teacher(){
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("select * from Teacher where teacherID = '"+ T_Login.currentTeacherID +"'");
        ...
        b5.setIcon(new ImageIcon("C:/Users/Kulkarni/IdeaProjects/JavaProject3/src/viewStudents.png"));
        ...
        b6.setIcon(new ImageIcon("C:/Users/Kulkarni/IdeaProjects/JavaProject3/src/myCourses.png"));
        ...
        b7 = new JButton("Add Quiz");
        b7.setIcon(new ImageIcon("C:/Users/Kulkarni/IdeaProjects/JavaProject3/src/updateCourse.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            T_Assignment t = new T_Assignment();
