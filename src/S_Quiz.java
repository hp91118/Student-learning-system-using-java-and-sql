...
public class S_Quiz extends JFrame implements ActionListener{
    ...
    public S_Quiz(){
        ...
        title = new JLabel("Take Quiz", JLabel.CENTER);
        ...
        quizCbLbl = new JLabel("Select Quiz");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == subjectsCb){
          //  quizCb.removeAllItems();
            ...
            {
                quizC c = new quizC("C Programming Quiz");


            }
            else if(quiz.equals("Cpp Programming"))
            {
                quizcpp cpp = new quizcpp("Cpp Programming Quiz");

            }
            else if(quiz.equals("Python Programming"))
            {
                quizpython p = new quizpython("Python Programming Quiz");

            }
            else if(quiz.equals("Java Programming"))
            {
                quizjava j = new quizjava("Java Programming Quiz");
