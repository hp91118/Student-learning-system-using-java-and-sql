...
public class ViewCourses extends JFrame implements ActionListener{
    ...
    private void getCourses(String subjectName){
        ...
        try{
            ...
            String q = "select C.Name As Course, CONCAT(T.firstName, ' ', T.lastName) As Teacher_Name, T.emaiId As Teacher_Email"
                    + " from Courses As C"
            ...
            if(subjectName.isEmpty()){
                q = "select C.Name As Course, CONCAT(T.firstName, ' ', T.lastName) As Teacher_Name, T.emaiId As Teacher_Email"
                        + " from Courses As C"
                        + " Inner Join Teacher As T ON T.teacherID = C.teacherID";
            }
